# The Revision Process {#sec-revision}

::: {.callout-note icon="false"}
## In a nutshell

- Sort every reviewer comment into must do, negotiate, or resist before writing a single word of your response
- Work on a copy of the submitted file with track changes enabled, never the original
- The cover letter signals that you have done the work; the response document records every comment and every change
:::
...
## The cover letter {#sec-cover-letter}
...
**States what the paper is.** One sentence — the anchor sentence from your theoretical framing, adapted for a non-specialist editor. 
...
## The response document {#sec-response-document}
...
**Be specific about what you changed.** "We have revised this section" tells the reviewer nothing. "We have added two sentences on p. 4 clarifying the relationship between our manipulation and the boundary detection measure" tells them exactly what changed and where.
...
Firmness and respect are not opposites. A response that comes across as dismissive or impatient — even when you are right — can damage your chances with the editor. The strong response template in @sec-review is firm precisely because it is specific and engaged, not because it is blunt. When in doubt, err on the side of explaining more rather than less. A reviewer who feels heard is more likely to accept a principled disagreement than one who feels dismissed.

This does not mean being sycophantic; hollow praise reads as hollow. It means being direct, being specific, and treating the process as a collaboration even when it does not feel like one.
...
**Resist.** Changes that would genuinely weaken the paper — including, as discussed in Chapter 6, requests to add theoretical coverage that does no argumentative work. These require a polite, principled, specific response.

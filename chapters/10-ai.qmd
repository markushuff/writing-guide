...
AI writing tools — by which this chapter means large language model-based tools such as ChatGPT, Claude, Gemini, and similar systems — are now part of academic life. Most researchers use them in some form — for drafting, for editing, for overcoming the paralysis of the blank page. 

Used poorly, they make exactly the problem this guide is about significantly worse.

# Two Filters, Three Outcomes {#sec-filters}
...
- Fail F1 and the theory earns a citation; fail F2 and it earns a brief mention; pass both and it earns full treatment
:::
...
## Filter 1 (F1): Does it make a different prediction from your anchor? {#sec-f1}
...
## Filter 2 (F2): Does it reach your dependent variable mechanistically? {#sec-f2}
...
::: {.callout-note icon="false"}
## What strong inference means {#sec-strong-inference}
...
## Your landscape sentence {#sec-landscape}
